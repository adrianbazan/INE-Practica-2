...
class UserTest < ActionDispatch::IntegrationTest
  ...
  module BrowsingTestDSL
    ...
    def creates_user_account(parameters)
      ...
      assert_equal flash[:notice], "Cuenta #{user_name} creado correctamente. Sesión iniciada."
      assert_tag :tag => 'div', :attributes => { :id => 'notice' },
                                :content => "Cuenta #{user_name} creado correctamente. Sesión iniciada."
    ...
    def edits_user_account(user_account, parameters)
      ...
      assert_tag :tag => 'div', :attributes => { :id => 'notice' },
                                :content => "Cuenta #{user_name} actualizada correctamente."      
      assert_tag :tag => 'dt', :content => 'Nombre'
      assert_tag :tag => 'dd', :content => user_name
    end
  end
